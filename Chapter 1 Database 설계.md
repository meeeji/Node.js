...
![image](https://github.com/user-attachments/assets/be0678cc-f9ac-4e03-830e-1a6fd83c3377)
...
- **미션 기록**
    ...
    ![image](https://github.com/user-attachments/assets/58f243b4-d841-483c-bada-1fe270d2e410)

    3. 구상한 테이블을 바탕으로, 실제 테이블을 설계해보았다.(ERD CLOUD 사용)
    4. 각 테이블 간의 관계를 생각하며 관계선을 연결시켜주었다.
    
    ![image](https://github.com/user-attachments/assets/d476e0b8-e906-40e0-94a5-4763b5c1d5f4)
    ...
    6. 피드백을 반영하여 ERD를 수정해보았다.
    
    ![image](https://github.com/user-attachments/assets/8112a070-24ec-4efd-82a0-88203e2f4df2)
